...
videoname = 'raga safe' #input video clip name
...
lower_color= np.array([9, 106, 152]) - sens
upper_color = np.array([60, 252, 255]) + sens
...
result = cv2.VideoWriter(videoname + ' fitEllipse.mp4',
